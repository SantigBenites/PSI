...
export class HeroService {
  ...
  addHero(hero: Hero): Observable<Hero> {
    ...
    return this.http.post<Hero>(url, JSON.stringify(hero), this.httpOptions).pipe(
      tap((newHero: Hero) => {
  ...
  updateHero(hero: Hero): Observable<any> {
    ...
    if(hero.pet == undefined){
      var json_obj = JSON.parse( heroJSON );
      json_obj['pet'] = null;
      heroJSON = JSON.stringify(json_obj)
    }

    return this.http.put<Hero>(url, heroJSON, this.httpOptions).pipe(
